 ...
 * @see [./src/clonefile.cjs]{@link ./src/clonefile.cjs}
 * 
 **/
import { fileURLToPath } from "url";
import { dirname } from "path";
const __dirname = dirname(fileURLToPath(import.meta.url));
import {constants, existsSync, mkdirSync, readFileSync, lstatSync, createWriteStream, createReadStream, copyFileSync}  from "fs";
...
import {EOL}  from "os";
import {LIMIT_FILES, SKIP_MESSAGE}  from "./constants.mjs";
/**
...
export const displayLog  = (message, {fg = "yellow", silent = false} = {}) =>
{
    if (silent)
    {
        return;
...
export const displayError  = (message, style = {fg: "red"}) =>
{
 ...
 * @returns {*|*[]}
 */
export function  determineTargets ({targets = [], argvTarget = null, argvTargets = null} = {})
{
    if (argvTarget)
    {
 ...
 */
export function  copyFileToFile (source, target, {
    force = false,
    silent = false,
    progressBar = null,
    dry = false,
 ...
 * @returns {{success: boolean}|{success: boolean, dest}}
 */
export function  copyFileToFolder (source, targetFolder, commonSourceDir, {
    force = false,
    silent = false,
    progressBar = null,
    dry = false,
 ...
 */
export function  copySourceToTarget (source, target, commonSourceDir, {
    force = false,
    targetStatus = null,
    silent = false,
    dry = false,
 ...
 */
export function  copyDetailedSourceToTargets (targets, {
    source,
    commonSourceDir,
    force,
    left = 0,
...
export function  cloneSources (sources, targets, {
    force = false,
    progress = false,
    silent = false,
    clearProgress = false,
...
export const cloneFromCLI  = (argv) =>
{
    try
    {
        let {
...
export const cloneGlobs  = (sources, targets, {
    silent = false,
    force = true,
    progress = false,
    clearProgress = false,
...
export const clone  = (source, targets, {
    silent = false,
    force = true,
    progress = false,
    clearProgress = false,
